...
return function(mod, JSON)
    ...
    G.FUNCS.bobs_replayer_load = function()
        protect(function()
    ...
    mod.config_tab = function()
        ...
        local buttons = {}
        for _, item in ipairs({{'Load Log', 'bobs_replayer_load'}, {'Next Run', 'bobs_replayer_next'}, {'Start Replay', 'bobs_replayer_start'}, {'Stop Replay', 'bobs_replayer_stop'}}) do
