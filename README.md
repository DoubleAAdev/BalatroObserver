...
**Replaying a Multiplayer game** from its Lovely log, so Action Recorder can record it, is now its own mod: [Balatro Replayer](https://github.com/DoubleAAdev/BalatroReplayer). It was part of Observer up to 1.10.0.
