...
$files += @('start-viewer.ps1', 'start-viewer.cmd', 'viewer-server.cs', 'assets/wiki-art.json', 'assets/wiki-art.js', 'launcher.lua', 'open-viewer.lua', 'start-viewer.js', 'score-preview.js', 'assets/calculator/balatro-sim.js', 'assets/calculator/joker-ids.json', 'assets/calculator/joker-ids.js')
