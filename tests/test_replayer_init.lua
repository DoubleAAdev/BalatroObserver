...
G = {STAGE = 1, STAGES = {MAIN_MENU = 1, RUN = 2}, STATES = {}, FUNCS = {}, UIT = {R = 'R', C = 'C', T = 'T'}, C = {WHITE = {}, BLUE = {}}, SETTINGS = {}}
