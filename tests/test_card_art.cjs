...
(async()=>{
 ...
 try{
  ...
  let payload={state:{schema_version:1,available:true,session:'art-test',sequence:1,observed_at:Math.floor(Date.now()/1000),phase:'SELECTING_HAND',mod_version:'1.0.1',
