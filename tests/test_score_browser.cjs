...
(async()=>{
 ...
 try{
  ...
  assert.deepEqual(await page.evaluate(()=>[value(1.234567),value(12),el('p','X1.234567 Mult, +0.30000000004 Mult').textContent,el('p','v0.7.5').textContent]),['1.23','12','X1.23 Mult, +0.30 Mult','v0.7.5']);
